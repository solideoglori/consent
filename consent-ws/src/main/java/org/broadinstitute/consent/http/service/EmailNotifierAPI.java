...
public interface EmailNotifierAPI {
    ...
    void sendResearcherDarApproved(String darCode, Integer researcherId, List<DatasetMailDTO> datasets, String dataUseRestriction) throws MessagingException, IOException, TemplateException, Exception;
